# ImpactBridge Documentation Index

- `API_TESTING_GUIDE.md` – full Postman-based testing steps with required payloads and roles.
- `FRONTEND_BUSINESS_GUIDE.md` – guidance for integrating client apps across roles.
- `TECHNICAL_OVERVIEW.md` – module architecture, utilities, and roadmap context.
- `BUSINESS_STATUS.md` – summary of completed features and upcoming work.
