...
## 28. [FE] Admin dashboard marked as client component.
...
## 29. [FE] Build pipeline refreshed and docs updated.
...
## 30. [FE] Sonner toast provider wired at root layout.
...
## 31. [FE] Docs refreshed for global toaster integration.
...
## 32. [FE] Sidebar links now prefetch with reduced rerenders.
...
## 33. [FE] Auth context now persists JWT + user via localStorage.
...
## 34. [FE] Auth redirect updated to /auth/login for storage bootstrap.
...
## 35. [FE] Admin welcome toast now session-scoped.
...
## 36. [FE] Docs updated for persistent auth & session toast.
...
## 37. [FE] Dashboard skeleton loaders introduced.
...
## 38. [FE] Documentation refreshed for skeleton loading experience.
...
## 39. [FE] Detailed progress report documented.
...
## 40. [FE] Static admin activity feed added.
...
## 41. [FE] Dashboard UX polish: search bar, scrollable nav, safe redirects.
...
## 42. [FE] Admin NGO management table (mock data) implemented.
...
## 43. [FE] NGO management sorting, pagination, and detail drawer.
...
## 44. [FE] NGO smart filters + global search.
...
## 45. [FE] NGO detail drawer with tabs and approval actions.
...
## 46. [FE] Admin dashboard analytics refresh.
...
## 47. [FE] Dashboard StatCard + CSR submissions chart.
...
## 48. [FE] Super Admin profile page hardened + docs refreshed.
...
## 49. [FE] Notifications hub + header badge.
...
## 50. [FE] README refreshed for current dashboard + notifications scope.
...
## 51. [FE] User directory added for super admins.
...
## 52. [FE] User detail view with tabs + actions.
...
## 53. [FE] NGO compliance documents workspace documented.
...
## 54. [FE] Profile drawer trigger de-nested to eliminate hydration warning.
...
## 55. [FE] Responsive polish + memoization pass across dashboards.
...
## 56. [FE] Global scrolling + auth layout responsiveness.
...
## 57. [FE] Document approvals workflow polished.
...
## 58. [FE] Sidebar menu reordered for clarity.
...
## 59. [FE] Document security preview enhanced.
...
## 60. [FE] Document collaboration panel delivered.
...
## 61. [FE] Build config + documentation sync.
...
## 62. [FE] Document lifecycle UI + approval workflow polish.
...
## 63. [FE] Access control modal scaffolded.
...
## 64. [FE] Timeline panel & documentation sync.
...
## 65. [FE] Activity notifications popover + mobile sheet.
...
## 66. [FE] Smart suggestions card + layout polish.
...
## 67. [FE] Command palette + fast navigation polish.
...
## 68. [FE] Admin analytics charts restyled with minimal visuals.
...
## 69. [FE] Cleaned Next config warning.
...
## 70. [FE] Route prefetch & navigation polish.
...
## 71. [FE] Chart container sizing hardened.
...
## 72. [FE] Dependency pruning & repo tidy.
...
## 74. [FE] Theme + type standardisation.
...
## 75. [FE] NGO module typography alignment.
...
## 76. [FE] Accessibility & usability polish.
...
## 78. [FE] Must-fix QA item addressed.
...
## 79. [FE] QA copy cleanup & reset-password polish.
...
## 80. [FE] Company management workspace.
...
## 81. [FE] Company profile detail view.
...
## 82. [FE] Company programmes listing.
...
## 83. [FE] Company programme detail view.
...
## 84. [FE] Programme insight cards & animated progress.
...
## 86. [FE] i18n scaffold with locale switcher.
...
## 87. [FE] Impact trend chart placeholder.
...
## 89. [FE] Storybook scaffold + core stories.
...
## 91. [FE] Breadcrumb navigation standardised.
...
## 92. [FE] Optimistic NGO assignment.
...
## 93. [FE] Offline-aware UX scaffold.
...
## 94. [FE] Admin onboarding walkthrough scaffolded (pending cleanup).
...
## 95. [FE] Admin onboarding cleanup.
...
## 96. [FE] Global search spotlight rollout.
...
## 98. 2025-02-14 — API Client Scaffold
...
## 100. Frontend Server Auth Guard

- Added server-side middleware checking mock session & role cookies before dashboard routes render.
- Synced AuthProvider to mirror cookies for placeholder session logic without altering UI.
- Builds remain green (npm run init, npm run build).
