...
- Add CSR programme detail view with tabs for overview, timeline, documents, NGOs, milestones, comments, and assign modal workflow. ✅ Implemented (`/dashboard/admin/company/[companyId]/programmes/[programmeId]`).
