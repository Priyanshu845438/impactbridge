...
_Last reviewed: 2026-01-08 — API programme flag now covers the edit/update flow with hook-level tests; runtime fallback safeguards and page-level RTL coverage for edit remain pending before enabling the flag by default._
