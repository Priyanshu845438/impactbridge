...
_Last reviewed: 2026-01-13 — API programme flag now covers the edit/update flow with hook-level tests; runtime fallback safeguards are in place. Page-level RTL coverage for edit and end-to-end smoke validation remain pending before enabling the flag by default._
