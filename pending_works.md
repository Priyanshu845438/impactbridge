...
- **Notifications** — 🟠 Incomplete (intent storage capturing channel/recipient/payload from approvals events); _pending_: add safe delivery processor, retries, provider metrics, and long-term worker orchestration.
