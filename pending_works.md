...
9. CSR programme activity logging still unimplemented: request context plumbing now exposes optional actorId but ActivityLogService wiring remains pending (no logs yet); logging task remains outstanding until ActivityLogService emitters are wired.
