...
9. CSR programme activity logging still unimplemented: service lacks actor context, so guard/channel strategy must be clarified before adding ActivityLogService calls.
